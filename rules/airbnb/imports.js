// Note: This file contains import rules but env/parserOptions/plugins/settings 
// are now handled in the main config files (base.js, index.js) for flat config
...
export const rules = {
    ...
    'import/no-extraneous-dependencies': ['error', {
        devDependencies: [
            ...
            '**/*{.,_}{test,spec}.{js,jsx}', // tests where the extension or filename suffix denotes that it is a
                                             // test
