...
const { rules: baseBestPracticesRules } = require('../../airbnb/best-practices');
const { rules: baseErrorsRules } = require('../../airbnb/errors');
const { rules: baseES6Rules } = require('../../airbnb/es6');
const { rules: baseImportsRules } = require('../../airbnb/imports');
const { rules: baseStyleRules } = require('../../airbnb/style');
const { rules: baseVariablesRules } = require('../../airbnb/variables');
...
module.exports = {
    ...
    rules: {
        ...
        // The TypeScript version also adds 3 new options, all of which should be set to the same value as the base
        // config
        'comma-dangle': 'off',
